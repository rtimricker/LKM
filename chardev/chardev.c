...
static void device_isr_bh ( device_isr_bh_arg_t * );
...
static void 
device_isr_bh ( device_isr_bh_arg_t* bh )
{
...
work_handler(struct work_struct *work)
{
    ...
    printk ( KERN_INFO "Chardrv: work_handler ! ! ! ! !\n" );
    kfree(data);
    data = NULL;
} 
...
static int __init device_init(void)
{
  ...
  wq = alloc_workqueue("wq_test", WQ_UNBOUND | WQ_MEM_RECLAIM, 1);
